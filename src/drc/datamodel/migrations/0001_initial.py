    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identificatie', models.CharField(help_text='Een binnen een gegeven context ondubbelzinnige referentie naar het INFORMATIEOBJECT.', max_length=40, validators=[zds_schema.validators.AlphanumericExcludingDiacritic()])),
                ('bronorganisatie', models.CharField(blank=True, help_text='Het RSIN van de Niet-natuurlijk persoon zijnde de organisatie die het informatieobject heeft gecreëerd of heeft ontvangen en als eerste in een samenwerkingsketen heeft vastgelegd.', max_length=9, null=True, validators=[zds_schema.validators.validate_non_negative_string])),
