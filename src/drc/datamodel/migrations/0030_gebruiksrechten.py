...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('datamodel', '0029_auto_20181224_1042'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('informatieobject', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='datamodel.EnkelvoudigInformatieObject')),
            ],
            options={
