    ...
    operations = [
        migrations.AddField(
            ...
            field=models.DateField(
                blank=True,
                help_text="De datum waarop het INFORMATIEOBJECT ontvangen is. Verplicht te registreren voor INFORMATIEOBJECTen die van buiten de zaakbehandelende organisatie(s) ontvangen zijn.",
                null=True,
