...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            name='archiefstatus',
            field=models.CharField(choices=[('nog_te_archiveren', 'De zaak cq. het zaakdossier is nog niet als geheel gearchiveerd.'), ('gearchiveerd', 'De zaak cq. het zaakdossier is als geheel niet-wijzigbaar bewaarbaar gemaakt.')], default='nog_te_archiveren', help_text='Aanduiding of het zaakdossier blijvend bewaard of na een bepaalde termijn vernietigd moet worden.', max_length=40, verbose_name='archiefstatus'),
        ),
        migrations.AddField(
            model_name='enkelvoudiginformatieobject',
            name='bevat_persoonsgegevens',
            field=models.CharField(choices=[('onbekend', 'Niet bekend of het document persoonsgegevens bevat dieniet vrijelijk openbaar gemaakt mogen worden.'), ('ja', 'Niet bekend of het document persoonsgegevens bevat dieniet vrijelijk openbaar gemaakt mogen worden.'), ('nee', 'Bevat geen persoonsgegevens die niet vrijelijk openbaargemaakt mogen worden.')], default='onbekend', help_text='Legt vast of het document persoonsgegevens bevat die niet vrijelijk openbaar gemaakt mogen worden.', max_length=40, null=True, verbose_name='bevat persoonsgegevens'),
        ),
        migrations.AddField(
            model_name='enkelvoudiginformatieobject',
            name='ontvangen',
            field=models.BooleanField(blank=True, default=None, help_text='Legt vast of het document afkomstig is van een externe partij.', null=True, verbose_name='ontvangen'),
        ),
        migrations.AddField(
            model_name='enkelvoudiginformatieobject',
            name='vervallen',
            field=models.BooleanField(blank=True, default=None, help_text='Legt vast of het document een rol speelt in het huidige of toekomstige proces.', null=True, verbose_name='vervallen'),
        ),
