...
version = '.'.join(map(str, drc.VERSION[0:2]))
# The full version, including alpha/beta/rc tags
release = drc.__version__
...
man_pages = [
    (master_doc, 'drc', 'drc Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'drc', 'drc Documentation',
     author, 'drc', 'One line description of project.',
     'Miscellaneous'),
]
